...
def get_columns(filters):
	columns = [
		{"label": _("Sales Invoice"), "fieldname": "sales_invoice", "fieldtype": "Data", "width": 130 },
		{"label": _("SI Date"), "fieldname": "sales_invoice_date", "fieldtype": "Data", "width": 100 },

	]
	if not filters.get("update_stock"):
		columns += [
			{"label": _("Delivery Note"), "fieldname": "delivery_note", "fieldtype": "Data", "width": 130},
			{"label": _("DN Date"), "fieldname": "delivery_note_date", "fieldtype": "Data", "width": 100},
		]
	...
	if not filters.get("update_stock"):
		columns += [
			{"label": _("DN Qty"), "fieldname": "dn_qty", "fieldtype": "Float", "width": 70},
		]
	columns += [
		{"label": _("SI Qty"), "fieldname": "si_qty", "fieldtype": "Float", "width": 70},
		...
		{"label": _("Gross Profit %"), "fieldname": "gross_profit_percent", "fieldtype": "Data", "width": 112},
